...
catalogUri="/WEB-INF/queries/cube3.xml">
select {([mondian_Table3.Etos].[All mondian_table3.etos],[mondian_Table3.deiktis])} on rows,
 {[Measures].[SUM of mondian_Table3.timi],[Measures].[SUM of mondian_Table3.seira_katataksis]} on columns
  from cube3
</jp:mondrianQuery>
