...
public class DeletePatientConsentAction extends GnProcessAction {
	...
	protected void processActionLocal(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (patientResult != null && patientResult.size() > 0)
			{
				...
				epsosHelper.deletePatientConsent(consentObject, patient, CommonUtil.getHttpServletRequest(req));
