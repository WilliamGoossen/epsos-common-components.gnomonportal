  ...
  <tr>
    <td valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top" class="lfr-column seventy" id="column-1">$processor.processColumn("column-1")</td>
          </tr>
          <tr>
            <td valign="top">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td valign="top" class="lfr-column thirty" id="column-2">$processor.processColumn("column-2")</td>
  </tr>
</table>
</div>
