...
<!--   <LINK href="/jpivot/style.css" rel="stylesheet" type="text/css"> -->



<form action="<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>">
<portlet:param name="struts_action" value="/ext/jpivot/mondrian"/></portlet:renderURL>" method="post">
...
<wcf:renderParam name="myPageUrl" value="<%=PortalUtil.getCurrentURL(request)%>"/>
<wcf:renderParam name="myPorltet" value="Jpivot"/>
</wcf:render>
