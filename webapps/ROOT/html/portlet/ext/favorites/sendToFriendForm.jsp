...
<a href="#TB_inline?height=235&width=300&inlineId=<portlet:namespace />hiddenModalContent<%=idParam%>&modal=false" class="thickbox">
...
<div id="<portlet:namespace />hiddenModalContent<%=idParam%>" style="display:none">
	...
	<script type="text/javascript")>
		...
		function <portlet:namespace />sendToFriend<%=idParam%>() {
			var callurl = '<%= themeDisplay.getPathMain() %>/ext/favorites/send';
