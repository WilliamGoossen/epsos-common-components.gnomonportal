...
<h3><%= LanguageUtil.get(pageContext, "ec.admin.suppliers") %></h3>
...
<% PrSupplier gnItem = (PrSupplier) pageContext.getAttribute("item"); %>
<display:column property="supplierName" titleKey="name" sortable="true" style="width:100%">
</display:column>
				...
				<tr>
					...
					<td>
						<a href="<portlet:actionURL>
								<portlet:param name="struts_action" value="/ext/products/admin/loadSupplier"/>
