...
<h3><%= LanguageUtil.get(pageContext, "ec.admin.metrics") %></h3>
...
<display:column property="field1" titleKey="name" sortable="true" style="width:100%">
</display:column>
				...
				<tr>
					...
					<td>
						<a href="<portlet:actionURL>
								<portlet:param name="struts_action" value="/ext/products/admin/loadMetric"/>
