...
<display:table id="item" name="product_items" requestURI="//ext/products/admin/listProductDiscounts?actionURL=true" sort="list" export="false" style="font-weight: normal; width: 100%; border-spacing: 0">
<% PrProductdiscount gnItem = (PrProductdiscount) pageContext.getAttribute("item"); %>
<display:column property="dateFrom" titleKey="ec.admin.product.discount.from" sortable="true" decorator="org.displaytag.sample.LongDateTimeWrapper" />
<display:column property="dateTo" titleKey="ec.admin.product.discount.to" sortable="true" decorator="org.displaytag.sample.LongDateTimeWrapper" />
<display:column property="impactPrice" titleKey="ec.admin.product.discount.impact" sortable="true"/>
<display:column titleKey="ec.admin.product.feature.impact.type" sortable="true">
<%= (gnItem.getImpactType() == CommonDefs.PRODUCT_IMPACT_EXACT ?
				...
				<tr>
					...
					<td>
						<a href="<portlet:actionURL>
								<portlet:param name="struts_action" value="/ext/products/admin/loadProductDiscount"/>
