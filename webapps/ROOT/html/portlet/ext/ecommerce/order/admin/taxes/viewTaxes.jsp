...
<h3><%= LanguageUtil.get(pageContext, "ec.admin.taxes") %></h3>
...
<% EcTax gnItem = (EcTax) pageContext.getAttribute("item"); %>
<display:column titleKey="ec.admin.tax.taxrate" sortable="true" style="width:100%">
<%= gnItem.getTaxrate() != null? com.ext.portlet.ecommerce.product.service.ProductBrowserService.d2s(gnItem.getTaxrate().doubleValue()) + " %" : "-" %>
</display:column>
				...
				<tr>
					...
					<td>
						<a href="<portlet:actionURL>
								<portlet:param name="struts_action" value="/ext/orders/admin/loadTax"/>
