...
String formUrl = "/ext/orders/admin/updateShipping?actionURL=true" ;
String buttonText = "gn.button.update";
String titleText = "ec.admin.shipping.edit";
if (!Validator.isNull(loadaction) && loadaction.equals("delete"))
{
 	formUrl = "/ext/orders/admin/deleteShipping?actionURL=true" ;
 	buttonText = "gn.button.delete";
 	titleText = "ec.admin.shipping.delete";
}
else if (!Validator.isNull(loadaction) && loadaction.equals("add"))
{
	formUrl = "/ext/orders/admin/addShipping?actionURL=true" ;
	buttonText = "gn.button.add";
	titleText = "ec.admin.shipping.add";
}
else if (!Validator.isNull(loadaction) && loadaction.equals("trans"))
{
	formUrl = "/ext/orders/admin/addShipping?actionURL=true" ;
	buttonText = "gn.button.add-translation";
	titleText = "ec.admin.shipping.add-translation";
}
%>

<tiles:insert page="/html/portlet/ext/ecommerce/order/admin/header.jsp" flush="true">
	<tiles:put name="tab"><%= com.ext.portlet.ecommerce.order.admin.ViewAction.TAB_SHIPPINGS %></tiles:put>
</tiles:insert>
...
<tiles:insert page="/html/portlet/ext/struts_includes/struts_div_fields.jsp" flush="true">
	<tiles:put name="formName" value="EcShippingForm"/>
</tiles:insert>

<div class="button-holder">
<html:submit styleClass="portlet-form-button"><%= LanguageUtil.get(pageContext, buttonText ) %></html:submit>

<logic:notEqual name="EcShippingForm" property="lang" value="<%= defLang %>">
	<c:if test="<%=!loadaction.equals("trans")%>">
		<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
		  <tiles:put name="action"  value="/ext/orders/admin/deleteShipping" />
...
<c:if test="<%=loadaction.equals("edit")%>">
	...
	<tiles:insert page="/html/portlet/ext/struts_includes/translationButtons.jsp" flush="true">
		<tiles:put name="editAction"  value="/ext/orders/admin/loadShipping" />
		<tiles:put name="editActionParam" value="loadaction"/>
	    <tiles:put name="editActionParamValue" value="edit"/>
	    <tiles:put name="addAction"  value="/ext/orders/admin/loadShipping" />
