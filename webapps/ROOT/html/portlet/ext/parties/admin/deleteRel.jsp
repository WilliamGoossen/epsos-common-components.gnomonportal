...
<h3 class="title1"><%= LanguageUtil.get(pageContext, "parties.admin.form.delete-rel") %></h3>
...
fields.addElement(new StrutsFormFields("name","parties.admin.partyrelationshiptype.name","text",false,true));
fields.addElement(new StrutsFormFields("description","parties.admin.partyrelationshiptype.description","text",false,true));
fields.addElement(new StrutsFormFields("clientRoleName","parties.admin.partyrelationshiptype.clientrolename","text",false,true));
fields.addElement(new StrutsFormFields("supplierRoleName","parties.admin.partyrelationshiptype.supplierrolename","text",false,true));
request.setAttribute("_vector_fields", fields);
%>
<html:form action="/ext/parties/admin/deleteRelType?actionURL=true" method="post">
