...
<h3 class="title1"><%= LanguageUtil.get(pageContext, "parties.admin.form.delete-org") %></h3>
...
fields.addElement(new StrutsFormFields("name","parties.admin.organizationtype.name","text",false, true));
fields.addElement(new StrutsFormFields("description","parties.admin.organizationtype.description","text",false, true));
request.setAttribute("_vector_fields", fields);
%>
<html:form action="/ext/parties/admin/deleteOrgType?actionURL=true" method="post">
