...
<%= LanguageUtil.get(pageContext, "parties.admin.form.add-possible-value-translation") %>
</logic:equal>
<logic:notEqual parameter="loadaction" value="trans">
<%= LanguageUtil.get(pageContext, "parties.admin.form.add-possible-value") %>
</logic:notEqual></h3>
...
<html:form action="/ext/parties/admin/addFeaturePossibleValue?actionURL=true" method="post">
...
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/admin/addFeaturePossibleValue" />
