...
<display:table id="addresses" name="addressesList" requestURI="//ext/parties/manager/listEmailAddresses?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action" style="font-weight: normal; width: 100%; border-spacing: 0">
<% PaEmailAddress addressItem = (PaEmailAddress) addresses;%>
...
menuItem = new DisplayTableActionMenuItem("parties.button.edit", 
	...
	menuItem.addParamNameValue("struts_action", "/ext/parties/manager/loadEmailAddress");
...
menuItem = new DisplayTableActionMenuItem("parties.button.delete", 
	...
	menuItem.addParamNameValue("struts_action", "/ext/parties/manager/deleteEmailAddress");
	menuItem.addParamNameValue("mainid", addressItem.getMainid().toString());
	menuItem.addParamNameValue("partyid", mainid);
...
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/manager/loadEmailAddress" />
