...
<html:form action="/ext/parties/manager/updateGeographicAddress?actionURL=true" method="post">
...
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/manager/deleteGeographicAddress" />
...
<br><br>
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/manager/listRelatedTelecomAddresses" />
...
<tiles:insert page="/html/portlet/ext/struts_includes/translationButtons.jsp" flush="true">
	<tiles:put name="editAction"  value="/ext/parties/manager/loadGeographicAddress" />
    ...
    <tiles:put name="addAction"  value="/ext/parties/manager/loadGeographicAddress" />
