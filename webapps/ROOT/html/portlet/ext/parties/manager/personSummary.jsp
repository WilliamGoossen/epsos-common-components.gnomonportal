...
new_field = new StrutsFormFields("prefix","parties.manager.person.prefix","text",false, true);
new_field.setRequired(true);
fields.addElement(new_field);
new_field = new StrutsFormFields("firstName","parties.manager.person.firstname","text",false, true);
new_field.setRequired(true);
fields.addElement(new_field);
new_field = new StrutsFormFields("familyName","parties.manager.person.familyname","text",false, true);
new_field.setRequired(true);
fields.addElement(new_field);
new_field = new StrutsFormFields("gender","parties.manager.person.gender","select",false, true);
new_field.setCollectionProperty("genders");
new_field.setCollectionLabel("genderKeys");
fields.addElement(new_field);
new_field = new StrutsFormFields("userId","parties.manager.person.userid","select",false, true);
new_field.setCollectionProperty("userIds");
new_field.setCollectionLabel("userIds");
fields.addElement(new_field);
request.setAttribute("_vector_fields", fields);
%>

<html:form action="/ext/parties/manager/loadPersonSummary?actionURL=true" method="post">
...
<display:table id="identifiers" name="identifiersList" requestURI="//ext/parties/manager/loadPersonSummary?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action" style="font-weight: normal; width: 100%; border-spacing: 0">
...
<display:table id="addresses1" name="emailAddressesList" requestURI="//ext/parties/manager/loadPersonSummary?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action">
...
<display:table id="addresses2" name="webpageAddressesList" requestURI="//ext/parties/manager/loadPersonSummary?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action">
...
<display:table id="addresses3" name="telecomAddressesList" requestURI="//ext/parties/manager/loadPersonSummary?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action">
...
<display:table id="addresses4" name="geographicAddressesList" requestURI="//ext/parties/manager/loadPersonSummary?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action">
...
<display:table id="roles" name="rolesList" requestURI="//ext/parties/manager/loadPersonSummary?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action">
...
<display:table id="relsClient" name="relsListClient" requestURI="//ext/parties/manager/loadPersonSummary?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action">
...
<display:table id="relsSupplier" name="relsListSupplier" requestURI="//ext/parties/manager/loadPersonSummary" pagesize="10" excludedParams="struts_action">
