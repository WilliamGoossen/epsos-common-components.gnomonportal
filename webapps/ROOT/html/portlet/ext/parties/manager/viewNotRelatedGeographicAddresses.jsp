...
<h2 class="title1"><%= LanguageUtil.get(pageContext, "parties.manager.list-available-geographic-address") %></h2>

<display:table id="addresses" name="addressesList" requestURI="//ext/parties/manager/listRelatedGeographicAddresses?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action" style="font-weight: normal; width: 100%; border-spacing: 0">
...
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/manager/relateToTelecomAddress" />
  <tiles:put name="buttonName" value="relateGeographicButton" />
  <tiles:put name="buttonValue" value="parties.button.relate-telecom" />
