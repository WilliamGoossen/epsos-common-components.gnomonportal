...
<h2 class="title1"><%= LanguageUtil.get(pageContext, "parties.manager.list-organization-names") %></h2>

<display:table id="names" name="namesList" requestURI="//ext/parties/manager/listOrganizationNames?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action" style="font-weight: normal; width: 100%; border-spacing: 0">
...
<display:column class="gamma1" property="field4" titleKey="parties.manager.organization.name"/>
...
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/manager/loadOrganizationName" />
...
%>
<br>
<html:link styleClass="beta1" action="/ext/parties/manager/loadOrganization" name="paramsName"><img src="/html/themes/classic/images/common/back.png" border="0" align="absmiddle">&nbsp;<%= LanguageUtil.get(pageContext, "parties.manager.back-to-organization") %></html:link>
<br>