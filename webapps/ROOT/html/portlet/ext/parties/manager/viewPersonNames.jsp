...
<display:table id="names" name="namesList" requestURI="//ext/parties/manager/listPersonNames?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action" style="font-weight: normal; width: 100%; border-spacing: 0">
...
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/manager/loadPersonName" />
...
%>
<br>
<html:link styleClass="beta1" action="/ext/parties/manager/loadPerson" name="paramsName"><img src="/html/themes/classic/images/common/back.png" border="0" align="absmiddle">&nbsp;<%= LanguageUtil.get(pageContext, "parties.manager.back-to-person") %></html:link>
<br>