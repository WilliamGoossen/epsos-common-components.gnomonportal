...
<display:table id="identifiers" name="identifiersList" requestURI="//ext/parties/manager/listPartyIdentifiers?actionURL=true" pagesize="10" sort="list" excludedParams="struts_action" style="font-weight: normal; width: 100%; border-spacing: 0">
...
menuItem = new DisplayTableActionMenuItem("parties.button.edit", 
	...
	menuItem.addParamNameValue("struts_action", "/ext/parties/manager/loadPartyIdentifier");
...
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/manager/loadPartyIdentifier" />
