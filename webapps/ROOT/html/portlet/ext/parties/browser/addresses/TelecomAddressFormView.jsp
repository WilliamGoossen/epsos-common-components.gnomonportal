...
try{
	...
	formActionUrl = (formActionUrl == null) ? "/ext/parties/browser/party_addresses_telecom_execute?actionURL=true" :formActionUrl;
...
<%= LanguageUtil.get(pageContext, "parties.manager.form.update-telecom-address") %>
<%}else if (loadAction.equals(Definitions.LD_ACTION_ADD)){%>
<%= LanguageUtil.get(pageContext, "parties.manager.form.add-telecom-address") %>
<%}%>

<%
Vector fields=null;
String curFormName="PrjTelecomAddressForm";
%>
...
<%
	...
	params.put(Definitions.PARTY_ADDRESS_SELECTED_TAB, Definitions.PARTY_ADDRESS_SUBTAB_TELECOM);
