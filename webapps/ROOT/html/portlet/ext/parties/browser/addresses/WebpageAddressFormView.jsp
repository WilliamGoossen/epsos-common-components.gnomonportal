...
try{
	...
	formActionUrl = (formActionUrl == null) ? "/ext/parties/browser/party_addresses_webpage_execute?actionURL=true" :formActionUrl;
...
<%= LanguageUtil.get(pageContext, "parties.manager.form.update-webpage-address") %>
<%}else if (loadAction.equals(Definitions.LD_ACTION_ADD)){%>
<%= LanguageUtil.get(pageContext, "parties.manager.form.add-webpage-address") %>
<%}%>

<%
Vector fields=null;
String curFormName="PrjWebpageAddressForm";
%>
...
<%
	...
	params.put(Definitions.PARTY_ADDRESS_SELECTED_TAB, Definitions.PARTY_ADDRESS_SUBTAB_WEB);
