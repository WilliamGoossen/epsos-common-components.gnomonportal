...
try{
	...
	formActionUrl = (formActionUrl == null) ? "/ext/parties/browser/party_addresses_geographic_execute?actionURL=true" :formActionUrl;
...
<%= LanguageUtil.get(pageContext, "parties.manager.form.update-geographic-address") %>
...
<%
Vector fields=null;
String curFormName="PrjGeographicAddressForm";
%>
...
<%
	...
	params.put(Definitions.PARTY_ADDRESS_SELECTED_TAB, Definitions.PARTY_ADDRESS_SUBTAB_GEOGRAPHIC);
