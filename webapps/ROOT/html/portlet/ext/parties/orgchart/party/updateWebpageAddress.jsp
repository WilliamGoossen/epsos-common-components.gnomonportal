...
<h3  class="title1"><%= LanguageUtil.get(pageContext, "parties.manager.form.update-webpage-address") %></h3>
...
<html:form action="/ext/parties/orgchart/updateWebpageAddress?actionURL=true" method="post">
