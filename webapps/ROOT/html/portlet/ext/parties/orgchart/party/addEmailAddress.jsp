...
<h3  class="title1"><%= LanguageUtil.get(pageContext, "parties.manager.form.add-email-address") %></h3>
...
<html:form action="/ext/parties/orgchart/addEmailAddress?actionURL=true" method="post">
