...
<h3  class="title1">
<%= LanguageUtil.get(pageContext, "parties.manager.form.delete-identifier") %></h3>
...
fields.addElement(new StrutsFormFields("partyid","partyid","text",true, true));
new_field = new StrutsFormFields("identifierType","parties.manager.identifier.identifiertype","select",false, true);
...
new_field = new StrutsFormFields("identifier","parties.manager.identifier.identifier","text",false, true);
fields.addElement(new_field);
new_field = new StrutsFormFields("registrationAuthority","parties.manager.identifier.registrationauthority","text",false, true);
fields.addElement(new_field);
/*new_field = new StrutsFormFields("validFrom","parties.manager.identifier.validfrom","date",false, true);
new_field.setDateFormat("%d/%m/%Y");
fields.addElement(new_field);
new_field = new StrutsFormFields("validTo","parties.manager.identifier.validto","date",false, true);
new_field.setDateFormat("%d/%m/%Y");
fields.addElement(new_field);*/
request.setAttribute("_vector_fields", fields);
%>

<html:form action="/ext/parties/orgchart/deletePartyIdentifier?actionURL=true" method="post">
