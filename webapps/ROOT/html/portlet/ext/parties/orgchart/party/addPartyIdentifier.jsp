...
<h3  class="title1">
<%= LanguageUtil.get(pageContext, "parties.manager.form.add-identifier") %></h3>
...
<html:form action="/ext/parties/orgchart/addPartyIdentifier?actionURL=true" method="post">
