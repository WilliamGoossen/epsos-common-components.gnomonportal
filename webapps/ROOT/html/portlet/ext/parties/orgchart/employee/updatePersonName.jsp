...
<html:form action="/ext/parties/orgchart/updatePersonName?actionURL=true" method="post">
...
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/parties/orgchart/deletePersonName" />
...
<tiles:insert page="/html/portlet/ext/struts_includes/translationButtons.jsp" flush="true">
	<tiles:put name="editAction"  value="/ext/parties/orgchart/loadPersonName" />
    ...
    <tiles:put name="addAction"  value="/ext/parties/orgchart/loadPersonName" />
