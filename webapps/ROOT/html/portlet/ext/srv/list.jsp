...
<h2  ><%= LanguageUtil.get(pageContext, "srv.list") %></h2>
<!-- Events List -->
<form name="SRV_Services_ButtonForm" action="/some/url" method="post">
<display:table id="service" name="services" requestURI="//ext/srv/list?actionURL=true" pagesize="20" sort="list" export="false" style="font-weight: normal; width: 100%; border-spacing: 0">
...
<display:column property="field2" titleKey="srv.registeredIdentifier" sortable="true" />
	...
	<tr>
		...
		<td>
			<a href="<portlet:actionURL>
					<portlet:param name="struts_action" value="/ext/srv/load"/>
...
<tr>
	...
	<liferay-portlet:param name="serviceid" value="<%=gnItem.getMainid().toString()%>"/></liferay-portlet:actionURL>">
...
<c:if test="<%= PortletPermissionUtil.contains(permissionChecker, plid, portletID, ActionExtKeys.ADD) %>">
	<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
	  <tiles:put name="action"  value="/ext/srv/load" />
	  <tiles:put name="buttonName" value="addButtonService" />
	  <tiles:put name="buttonValue" value="srv.button.add" />
	  <tiles:put name="formName"   value="SRV_Services_ButtonForm" />
