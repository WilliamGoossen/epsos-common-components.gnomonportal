...
<tiles:insert page="/html/portlet/ext/struts_includes/topicContentBrowser.jsp" flush="true">
	<tiles:put name="struts_action" value="/ext/documents/list"/>
	<tiles:put name="contentClass" value="gnomon.hibernate.model.base.documents.BsDocument"/>
	<tiles:put name="commandSpace" value="/html/portlet/ext/base/documents/menu/list_menu.jsp"/>
</tiles:insert>
