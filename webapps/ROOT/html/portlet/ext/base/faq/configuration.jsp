...
<form action="<liferay-portlet:actionURL portletConfiguration="true"></liferay-portlet:actionURL>" method="post" name="<portlet:namespace />fm"  class="uni-form">
	...
	<fieldset class="inline-labels"><legend><%= LanguageUtil.get(pageContext, "bs.configuration.faq-specific") %></legend>
	<%@ include file="/html/portlet/ext/base/faq/configurationCustomElems.jspf"%>
	</fieldset>
	</div>
