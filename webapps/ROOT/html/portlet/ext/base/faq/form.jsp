...
<tiles:insert page="/html/portlet/ext/struts_includes/metaData.jsp" flush="true">
	<tiles:put name="formName" value="BsFaqForm"/>
	<tiles:put name="className" value="gnomon.hibernate.model.base.news.BsFaq"/>
	<% com.ext.portlet.base.faq.BsFaqForm formBean = (com.ext.portlet.base.faq.BsFaqForm) request.getAttribute("BsFaqForm");
...
<logic:notEqual name="BsFaqForm" property="lang" value="<%= defLang %>">
	<c:if test="<%=!loadaction.equals("trans")%>">
		<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
		  <tiles:put name="action"  value="/ext/faq/delete" />
