...
<tiles:put name="struts_action" value="/ext/smslists/list"/>
<tiles:put name="contentClass" value="gnomon.hibernate.model.base.smslists.BsSmslist"/>
<tiles:putList name="actionParamList">
	<tiles:add value="one"/>
	<tiles:add value="two"/>
	<tiles:add value="three"/>
</tiles:putList>
...
<tiles:put name="commandSpace" value="/html/portlet/ext/base/smslists/menu/list_menu.jsp"/>
</tiles:insert>
...
<tr>
	<td colspan="6" style="background-color: #92A8C0;" height="1"></td>
</tr>
</tbody>
</table>
--%>