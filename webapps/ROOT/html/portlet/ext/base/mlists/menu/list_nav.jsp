...
<tiles:put name="contentClass" value="gnomon.hibernate.model.base.mlists.BsMlist"/>
...
<tiles:put name="commandSpace" value="/html/portlet/ext/base/mlists/menu/list_menu.jsp"/>
</tiles:insert>
