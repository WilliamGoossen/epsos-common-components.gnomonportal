...
<tiles:insert page="/html/portlet/ext/struts_includes/topicContentBrowser.jsp" flush="true">
	<tiles:put name="struts_action" value="/ext/civitems/list"/>
	<tiles:put name="contentClass" value="gnomon.hibernate.model.base.civitems.BsCivItem"/>
	<tiles:put name="commandSpace" value="/html/portlet/ext/base/civitems/menu/list_menu.jsp"/>
</tiles:insert>
