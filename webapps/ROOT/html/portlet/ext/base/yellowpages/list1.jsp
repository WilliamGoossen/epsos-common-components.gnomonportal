...
<!-- YellowPages List -->
<display:table id="yp" name="yellowpages" requestURI="//ext/yellowpages/list?actionURL=true" pagesize="25" sort="list" export="false" style="font-weight: normal; width: 100%; border-spacing: 0">
	<% ViewResult gnItem = (ViewResult) pageContext.getAttribute("yp"); %>
	<display:column titleKey="bs.yellowpages.title" sortable="false" >
    ...
    <c:if test="<%= gnItem.getField18()!=null && gnItem.getField16()!=null && Validator.isNotNull(gnItem.getField16().toString()) %>">
       <br/>
       <a href="<%= gnItem.getField16().toString() %>"><%=LanguageUtil.get(pageContext, "bs.yellowpages.ua.personal-web-space") %></a>
    </c:if>
	</display:column>
