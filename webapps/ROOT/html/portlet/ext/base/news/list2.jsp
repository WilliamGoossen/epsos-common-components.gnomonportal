...
<display:table id="new" name="news" requestURI="//ext/news/list?actionURL=true" pagesize="10" sort="list" export="false" style="width: 100%;">
    ...
    <a href="<portlet:actionURL>
			...
			<div class="date"><%= gnomon.business.DateUtils.convertDate(StringUtils.check_null(gnItem.getField3(),""),"yyyy-MM-dd HH:mm:ss","dd-MM-yyyy")%>&nbsp;-&nbsp; </div>
			<div class="title"><%= gnItem.getField4().toString() %></div></a>
