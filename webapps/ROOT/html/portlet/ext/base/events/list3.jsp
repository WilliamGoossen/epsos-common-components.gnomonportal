...
<!-- Events List -->
<% int counter = 0; %>
<display:table id="event" name="events" requestURI="//ext/events/list?actionURL=true" pagesize="10" sort="list" export="false" style="width: 100%;">
...
<% } %>
        ...
        <%= date_format.format((java.util.Date)gnItem.getField4()) %>
        </div>
