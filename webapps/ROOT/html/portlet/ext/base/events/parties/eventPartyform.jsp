...
String formUrl = "/ext/events/updateEventParty?actionURL=true" ;
String buttonText = "gn.button.update";
String titleText = "bs.events.parties.edit";
if (!Validator.isNull(loadaction) && loadaction.equals("delete"))
{
 	formUrl = "/ext/events/deleteEventParty?actionURL=true" ;
 	buttonText = "gn.button.delete";
 	titleText = "bs.events.parties.delete";
}
else if (!Validator.isNull(loadaction) && loadaction.equals("add"))
{
	formUrl = "/ext/events/addEventParty?actionURL=true" ;
	buttonText = "gn.button.add";
	titleText = "bs.events.parties.add";
}
else if (!Validator.isNull(loadaction) && loadaction.equals("trans"))
{
	formUrl = "/ext/events/addEventParty?actionURL=true" ;
	buttonText = "gn.button.add-translation";
	titleText = "bs.events.parties.add-translation";
}
%>
...
<logic:notEqual name="BsEventPartyForm" property="lang" value="<%= defLang %>">
<% if (!loadaction.equals("trans")) { %>
<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
  <tiles:put name="action"  value="/ext/events/deleteEventParty" />
...
<c:if test="<%=loadaction.equals("edit")%>">
	...
	<tiles:insert page="/html/portlet/ext/struts_includes/translationButtons.jsp" flush="true">
		<tiles:put name="editAction"  value="/ext/events/loadEventParty" />
		<tiles:put name="editActionParam" value="loadaction"/>
	    <tiles:put name="editActionParamValue" value="view"/>
	    <tiles:put name="addAction"  value="/ext/events/loadEventParty" />
