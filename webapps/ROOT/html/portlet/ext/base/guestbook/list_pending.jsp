...
<!-- Comments List -->
<display:table id="comment" name="pendingList" requestURI="//ext/comments/list?actionURL=true" pagesize="5" sort="list" export="false" style="font-weight: normal; width: 100%; border-spacing: 0">
