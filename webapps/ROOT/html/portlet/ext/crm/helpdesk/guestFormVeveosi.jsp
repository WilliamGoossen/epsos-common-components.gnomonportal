...
String formUrl = "/ext/crm/helpdesk/loadveveosi?actionURL=true" ;
...
if (!Validator.isNull(loadaction) && loadaction.equals(CrRequestForm.LOADACTION_ADD))
{
	...
	if(step.equals("step_one")) {
		formUrl = "/ext/crm/helpdesk/loadveveosi?actionURL=true" ;
	...
	titleText = "crm.helpdesk.request.veveosi.add";
}
