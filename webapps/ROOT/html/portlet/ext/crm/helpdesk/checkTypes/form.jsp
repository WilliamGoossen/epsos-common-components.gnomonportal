<%@ include file="/html/portlet/ext/crm/helpdesk/checkTypes/init.jsp" %>
...
String formUrl = "/ext/crm/helpdeskCheckTypes/update?actionURL=true" ;
String buttonText = "crm.button.update";
String titleText = "crm.helpdesk.checktype.edit";
if (!Validator.isNull(loadaction) && loadaction.equals("delete"))
{
 	formUrl = "/ext/crm/helpdeskCheckTypes/delete?actionURL=true" ;
 	buttonText = "crm.button.delete";
 	titleText = "crm.helpdesk.checktype.delete";
}
else if (!Validator.isNull(loadaction) && loadaction.equals("add"))
{
	formUrl = "/ext/crm/helpdeskCheckTypes/add?actionURL=true" ;
	buttonText = "crm.button.add";
	titleText = "crm.helpdesk.checktype.add";
}
else if (!Validator.isNull(loadaction) && loadaction.equals("trans"))
{
	formUrl = "/ext/crm/helpdeskCheckTypes/add?actionURL=true" ;
	buttonText = "crm.button.add-translation";
	titleText = "crm.helpdesk.checktype.add-translation";
}
%>
...
<tiles:put name="formName" value="CrCheckTypeForm"/>
...
<logic:notEqual name="CrCheckTypeForm" property="lang" value="<%= defLang %>">
	<c:if test="<%=!loadaction.equals("trans")%>">
		<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
		  <tiles:put name="action"  value="/ext/crm/helpdeskCheckTypes/delete" />
...
<img src="<%=  themeDisplay.getPathThemeImage() %>/common/back.png" border="0" align="absmiddle">&nbsp;<html:link action="/ext/crm/helpdeskCheckTypes/list"><%= LanguageUtil.get(pageContext, "crm.helpdesk.checktype.list") %></html:link>
...
<c:if test="<%=loadaction.equals("edit")%>">
	...
	<tiles:insert page="/html/portlet/ext/struts_includes/translationButtons.jsp" flush="true">
		<tiles:put name="editAction"  value="/ext/crm/helpdeskCheckTypes/load" />
		<tiles:put name="editActionParam" value="loadaction"/>
	    <tiles:put name="editActionParamValue" value="edit"/>
	    <tiles:put name="addAction"  value="/ext/crm/helpdeskCheckTypes/load" />
