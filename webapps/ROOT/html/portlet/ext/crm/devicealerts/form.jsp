...
String formUrl = "/ext/crm/devicealerts/update?actionURL=true" ;
String buttonText = "gn.button.update";
String titleText = "crm.devicealert.edit";
if (loadaction.equals("delete"))
{
 	formUrl = "/ext/crm/devicealerts/delete?actionURL=true" ;
 	buttonText = "gn.button.delete";
 	titleText = "crm.devicealert.delete";
}
else if (loadaction.equals("add"))
{
	formUrl = "/ext/crm/devicealerts/add?actionURL=true" ;
	buttonText = "gn.button.add";
	titleText = "crm.devicealert.add";
}
%>
...
<tiles:put name="formName" value="CrDeviceAlertForm"/>
</tiles:insert>
