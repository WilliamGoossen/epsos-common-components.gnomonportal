...
<h2  ><%= LanguageUtil.get(pageContext, "crm.tasktype.list") %></h2>
<!-- Events List -->
<form name="CRM_TaskTypes_ButtonForm" action="/some/url" method="post">
<display:table id="tasktype" name="tasktypes" requestURI="//ext/crm/tasktypes/list?actionURL=true" pagesize="20" sort="list" export="false" style="font-weight: normal; width: 100%; border-spacing: 0">

<% gnomon.hibernate.model.views.ViewResult gnItem = (gnomon.hibernate.model.views.ViewResult) pageContext.getAttribute("tasktype"); %>

<display:column property="field1" titleKey="crm.tasktype.name" sortable="true" />
	...
	<tr>
		...
		<td>
			<a href="<portlet:actionURL>
					<portlet:param name="struts_action" value="/ext/crm/tasktypes/load"/>
...
<c:if test="<%= PortletPermissionUtil.contains(permissionChecker, plid, portletID, ActionExtKeys.ADD) %>">
	<tiles:insert page="/html/portlet/ext/struts_includes/button.jsp" flush="true">
	  <tiles:put name="action"  value="/ext/crm/tasktypes/load" />
	  <tiles:put name="buttonName" value="addButtonTaskType" />
	  <tiles:put name="buttonValue" value="crm.button.add" />
	  <tiles:put name="formName"   value="CRM_TaskTypes_ButtonForm" />
