...
String formUrl = "/ext/crm/tasks/update?actionURL=true" ;
String buttonText = "gn.button.update";
String titleText = "crm.task.edit";
if (loadaction.equals("delete"))
{
 	formUrl = "/ext/crm/tasks/delete?actionURL=true" ;
 	buttonText = "gn.button.delete";
 	titleText = "crm.task.delete";
}
else if (loadaction.equals("add"))
{
	formUrl = "/ext/crm/tasks/add?actionURL=true" ;
	buttonText = "gn.button.add";
	titleText = "crm.task.add";
}
%>
...
<tiles:put name="formName" value="CrTaskForm"/>
</tiles:insert>
