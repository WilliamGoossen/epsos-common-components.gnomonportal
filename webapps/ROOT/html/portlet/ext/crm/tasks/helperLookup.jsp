...
<%
String lookupActionUrl = "/ext/crm/tasks/helperLookupAction?actionURL=true";
%>
...
<display:table id="items" name="itemsList" requestURI="//ext/crm/tasks/helperLookupAction" pagesize="10" sort="list" excludedParams="struts_action" style="font-weight: normal; width: 100%; border-spacing: 0">
