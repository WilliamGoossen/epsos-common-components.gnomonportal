...
<div id="thematikes-top"></div>
<div id="thematikes">
<c:choose>
	<c:when test="<%=instanceTopicView!=null%>">

		<script type="text/javascript" src="/html/js/simpletreemenu1.js"></script>
        <noscript></noscript>
...
private void _buildTopicNavigation(
	...
	List topicViewChildren = srv.getTopics(
			companyId, globalRootTopicView.getMainid()+"", rootTopicView.getMainid()+"", lang, "table1.orderIndex");
	...
	if (topicViewChildren!=null && topicViewChildren.size()>0) {
		...
		if (depth==0)
			...
			String rel = 
				(allParents.indexOf(rootTopicView.getMainid() + ",")>=0 
				 || selTopicId != null && selTopicId.equals(rootTopicView.getMainid().toString())) ? 
					"rel=\"open\"": "rel=\"closed\"";
