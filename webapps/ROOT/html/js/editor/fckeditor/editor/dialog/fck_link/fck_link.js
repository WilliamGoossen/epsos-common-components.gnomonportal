...
function Ok()
{
	...
	switch ( GetE('cmbLinkType').value )
	{
		case 'url' :
			...
			// GNOMON SA add thickbox link for parties contacts links
			if (oEditor.parent._gi9_fckEditor_showThickBoxParties == 'true') {
				if (sUri.indexOf('PA_CONTACTS') > -1)
				{
					GetE('txtAttClasses').value = "thickbox";
				}
			}
	...
	//http://www.fckeditor.net/forums/viewtopic.php?f=5&t=10462
	if ( !oLink ) {
