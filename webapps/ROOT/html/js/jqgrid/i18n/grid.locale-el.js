...
$.jgrid = {
	...
	edit : {
	    ...
	    bCancel: "Άκυρο",
		bClose: "Κλείσιμο",
		saveData: "Τα δεδομένα έχουν αλλάξει! Αποθήκευση αλλαγών?",
		bYes : "Yes",
		bNo : "No",
		bExit : "Cancel",
	    msg: {
			...
			url: "δεν είναι έγκυρη διεύθυνση URL. Απαιτείται πρόθεμα ('http://' or 'https://')",
			nodefined : " δεν έχει οριστεί!",
	...
	nav : {
		...
		viewtext: "",
		viewtitle: "Προβολή επιλεγμένης εγγραφής"
	},
	col : {
